...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <tr>
            ...
            <td>
                <div style="text-align: center;">
                    ...
                    <h4>EQUIPE DE ________________</h4>
                </div>
            </td>
    ...
    <br>
    <h3 style="text-align: center;"><b><u>JOVEM COORDENADOR</u></b></h3>
    @for ($i = 0; $i < 2; $i++)
    <p><b>Nome:</b>___________________________________<b>Contato:</b> ______________ <b>DN:</b> ___/___/_____</p>
        <p><b>Endereço:</b> _______________________________________ <b>Bairro:</b>________________________</p><br>
    @endfor
